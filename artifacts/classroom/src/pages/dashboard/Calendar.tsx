      ...
      <main className="max-w-6xl mx-auto px-4 pt-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-lg">
              Keep track of your lectures and AI-extracted deadlines.
            </p>
          </div>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-muted-foreground font-medium">Syncing calendar events...</p>
          </div>
        ) : (
        ...
        <div className="mt-8 flex items-center justify-center gap-8 bg-card border border-border p-4 rounded-2xl shadow-sm inline-flex">
          <div className="flex items-center gap-2 text-sm font-medium">
            ...
            <span className="text-muted-foreground">Lectures Added</span>
          </div>
          <div className="flex items-center gap-2 text-sm font-medium">
